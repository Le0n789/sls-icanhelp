...
export const MATERIALS_DATA: Material[] = [
  {
    ...
    properties: [
      ...
      { label: '拉伸强度(Z 方向)', value: 42, unit: 'MPa', testMethod: 'ISO 527-1/-2' },
      ...
      { label: '夏比冲击强度(+23℃)(X方向)', value: 53, unit: 'kJ/m²', testMethod: 'ISO 179/1eU' },
      { label: '夏比缺口冲击强度(+23℃)(X方向)', value: 4.8, unit: 'kJ/m²', testMethod: 'ISO 179-1/1eU' },
      { label: '伊佐德缺口冲击强度(+23℃)(X方向)', value: 4.4, unit: 'kJ/m²', testMethod: 'ISO 180/1A' },
      { label: '邵氏D硬度', value: 75, unit: '', testMethod: 'ISO 7619-1' },
      { label: '熔化温度', value: 175, unit: '℃', testMethod: 'ISO 11357-1/-3' },
      { label: '负载 1.80 MPa时的挠度温度(X 方向)', value: 64, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '负载 1.80 MPa时的挠度温度(Z 方向)', value: 57, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '维卡软化温度(X 方向)', value: 176, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '阻燃性能(厚度0.5mm)', value: 'HB', unit: '', testMethod: 'UL 94' },
      { label: '阻燃性能(厚度1.6mm)', value: 'HB', unit: '', testMethod: 'UL 94' },
      { label: '阻燃性能(厚度3.2mm)', value: 'HB', unit: '', testMethod: 'UL 94' },
      { label: '比较跟踪指数 CTI(X,Y,Z 方向)', value: '大于等于600', unit: '', testMethod: 'IEC 60112' },
    ],
  },

  {
    ...
    properties: [
      ...
      { label: '拉伸模量(X,Y 方向)', value: 1700, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '拉伸模量(Z 方向)', value: 1800, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '屈服伸长率(X,Y 方向)', value: 25, unit: '%', testMethod: 'ASTM D638' },
      { label: '屈服伸长率(Z 方向)', value: 20, unit: '%', testMethod: 'ASTM D638' },
      { label: '断裂延伸率(X,Y 方向)', value: 40, unit: '%', testMethod: 'ASTM D638' },
      { label: '断裂延伸率(Z 方向)', value: 25, unit: '%', testMethod: 'ASTM D638' },
      { label: '冲击强度(X,Y 方向)', value: 7.0, unit: 'kJ/m²', testMethod: 'ASTM D638' },
      { label: '冲击强度(Z 方向)', value: 4.5, unit: 'kJ/m²', testMethod: 'ASTM D638' },
...

  {
    ...
    properties: [
      ...
      { label: '伊佐德缺口冲击强度(+23℃)', value: 48, unit: 'J/m', testMethod: 'ASTM D256' },
      { label: '伊佐德冲击强度(+23℃)', value: 207, unit: 'J/m', testMethod: 'ASTM D256' },
...

  {
    ...
    properties: [
      { label: '拉伸强度(X,Y 方向)', value: 8.7, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '拉伸强度(Z 方向)', value: 7.2, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '断裂延伸率(X,Y 方向)', value: 310, unit: '%', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '断裂延伸率(Z 方向)', value: 110, unit: '%', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '伸长率为 50% 时的应力 (X,Y 方向)', value: 6.1, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '伸长率为 50% 时的应力 (Z 方向)', value: 5.9, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '伸长率为 100% 时的应力 (X,Y 方向)', value: 7.2, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '伸长率为 100% 时的应力 (Z 方向)', value: 7.0, unit: 'MPa', testMethod: 'ASTM D412-16(方法 A)' },
      { label: '抗撕裂强度(X,Y 方向)', value: 66, unit: 'kN/m', testMethod: 'ASTM D624-00 (2020)' },
      { label: '抗撕裂强度(Z 方向)', value: 39, unit: 'kN/m', testMethod: 'ASTM D624-00 (2020)' },
      ...
      { label: '维卡软化温度', value: 94.3, unit: '℃', testMethod: 'ASTM D1525' },
...

  {
    ...
    properties: [
      ...
      { label: '熔化温度', value: 176, unit: '℃', testMethod: 'ISO 11357-1/-3' },
      { label: '负载 1.80 MPa时的挠度温度(X 方向)', value: 144, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '负载 0.45 MPa时的挠度温度(X 方向)', value: 175, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '维卡软化温度(X 方向)', value: 169, unit: '℃', testMethod: 'ISO 306/B50' },
...

  {
    ...
    properties: [
      { label: '拉伸强度(X,Y 方向)', value: 31, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '拉伸强度(Z 方向)', value: 30, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '拉伸模量(X,Y 方向)', value: 2900, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '拉伸模量(Z 方向)', value: 3000, unit: 'MPa', testMethod: 'ASTM D638' },
      { label: '热变形温度(0.45MPa, 66psi)(X,Y 方向)', value: 170, unit: '°C', testMethod: 'ASTM D648' },
      { label: '热变形温度(0.45MPa, 66psi)(Z 方向)', value: 172, unit: '°C', testMethod: 'ASTM D648' },
      { label: '热变形温度(1.82MPa, 66psi)(X,Y 方向)', value: 113, unit: '°C', testMethod: 'ASTM D648' },
      { label: '热变形温度(1.82MPa, 66psi)(Z 方向)', value: 118, unit: '°C', testMethod: 'ASTM D648' },
      { label: '屈服延伸率(X,Y 方向)', value: 8, unit: '%', testMethod: 'ASTM D638' },
      { label: '屈服延伸率(Z 方向)', value: 4, unit: '%', testMethod: 'ASTM D638' },
      { label: '断裂伸长率(X,Y 方向)', value: 9, unit: '%', testMethod: 'ASTM D638' },
      { label: '断裂伸长率(Z 方向)', value: 5, unit: '%', testMethod: 'ASTM D638' },
...

{
...

  {
    ...
    properties: [
      ...
      { label: '夏比冲击强度(+23℃)(X,Y,Z 方向)', value: '无断裂', unit: '', testMethod: 'ISO 179/1eU' },
      { label: '夏比冲击强度(-30℃)(X 方向)', value: '无断裂', unit: '', testMethod: 'ISO 179/1eU' },
      { label: '夏比冲击强度(-30℃)(Z 方向)', value: '90', unit: 'kJ/m²', testMethod: 'ISO 179/1eU' },
      { label: '夏比冲击强度(-30℃,FORMIGA P 110 Velocis设备打印)(Z 方向)', value: '无断裂', unit: '', testMethod: 'ISO 179/1eU' },
      { label: '夏比冲击强度(-30℃,FORMIGA P 110 FDR设备打印)(Z 方向)', value: '无断裂', unit: '', testMethod: 'ISO 179/1eU' },
      { label: '夏比缺口冲击强度(+23℃)(X 方向)', value: 6.0, unit: 'kJ/m²', testMethod: 'ISO 179/1eA' },
      { label: '夏比缺口冲击强度(+23℃)(Y,Z 方向)', value: 5.5, unit: 'kJ/m²', testMethod: 'ISO 179/1eA' },
      { label: '邵氏D硬度', value: 75, unit: '', testMethod: 'ISO 7619-1' },
      { label: '熔化温度', value: 182, unit: '℃', testMethod: 'ISO 11357-1/-3' },
      { label: '负载 1.80 MPa时的挠度温度(X,Y 方向)', value: 46, unit: '℃', testMethod: 'ISO 75-1/-2' },
      { label: '负载 1.80 MPa时的挠度温度(Z 方向)', value: 47, unit: '℃', testMethod: 'ISO 75-1/-2' },
    ],
  }
];
